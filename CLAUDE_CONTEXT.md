...
## Last updated: 2026-06-18 (v1.5.2)
...
- Most recent release: `dev` merged into `main` at v1.4.29 (2026-06-17), fast-forwarded — tomboonern.com is current through v1.4.29. v1.5.0, v1.5.1, and v1.5.2 are on `dev` (tomboone.io) only, not yet released to `main`.
