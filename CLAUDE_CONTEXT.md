...
## Last updated: 2026-08-19 (v1.7.4 — live on dev, not yet on main)
...
- Current version: **v1.7.4** (live on dev only, not yet on main)
...
- **Most recent release to main: v1.6.15 (2026-08-18), fast-forwarded.** `dev` is now ahead of `main` at **v1.7.4** (2026-08-19) — the new Gender Reassignment Surgery CME Approval Audit tool, added at v1.7.0, patched at v1.7.1 for a header-matching bug, refined at v1.7.2 (accordion structure, age filters, column reorder), simplified at v1.7.3 (Explanation column reduced to bare ICD-10 code), and expanded at v1.7.4 (accepted-approver list widened beyond CME — see its own section below), plus a v1.7.2 Equipment Request Audit Creation User column, have **not** been released to production yet; they exist only on `dev`/tomboone.io until Tom explicitly says "release" (reconfirmed 2026-08-19: a bare "merge" request was treated as ambiguous per this convention and explicitly declined pending the word "release").
