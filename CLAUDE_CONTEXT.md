...
## Last updated: 2026-06-11 (v1.4.19)
...
- Table 2 column widths: class `cpt-discrepancy-table` on the dynamically-built Table 2 `<table>`; CSS `th:nth-child` rules in styles.css set widths to ~8% Date, ~10% Location, ~9% Case #, ~25% Missing, ~25% Not on Order, ~23% Invalid. The old `cpt-missing-table` and `cpt-invalid-table` CSS rules were removed in v1.4.19.
