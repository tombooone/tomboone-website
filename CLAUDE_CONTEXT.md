...
## Last updated: 2026-06-19 (v1.5.4)
...
4. **OR Staffing Budget Calculator** ✅ complete (v1.5.3 tool; v1.5.4 corrected the FTE math and added a scheduled-staffing comparison panel — per-day budgeted staff hours + FTEs from scheduled OR minutes, plus a live "budget variance" vs. scheduled 8/10/12-hr staff; see Key Decisions)
...
- Most recent release: `dev` merged into `main` at v1.4.29 (2026-06-17), fast-forwarded — tomboonern.com is current through v1.4.29. v1.5.0 through v1.5.4 are on `dev` (tomboone.io) only, not yet released to `main`.
