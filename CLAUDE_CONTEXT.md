...
## Last updated: 2026-06-19 (v1.5.3)
...
4. **OR Staffing Budget Calculator** ✅ complete (v1.5.3 — per-day budgeted staff hours + FTEs from scheduled OR minutes; see Key Decisions)
...
- Most recent release: `dev` merged into `main` at v1.4.29 (2026-06-17), fast-forwarded — tomboonern.com is current through v1.4.29. v1.5.0 through v1.5.3 are on `dev` (tomboone.io) only, not yet released to `main`.
